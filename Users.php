...
<div class="row">
<div class="col-md-12">
  <h1><i class="fas fa-users" style="color:#27aae1;"></i>  المستخدمين</h1>
</div>
</div>
</div>
</header>
    ...
    <div class="offset-lg-1 col-lg-10" style="min-height:400px;">
        ...
        <div class="card bg text-light mb-3" style="background-color:#4dc47d;">
           ...
           <div class="card-body bg" style="background-color:#133922;">
             <div class="form-group">
               ...
               <input class="form-control" type="text" name="User" id="username"value=""></input>
             </div>
             <div class="form-group">
     ...
     <tbody>
       <tr>
         ...
         <td><a href="Deleteuse.php?id=<?php echo $Id; ?>"><span class="btn btn-danger">الحذف</span></a></td>
       </tr>
     </tbody>
   <?php } ?>
       </table>
