...
if (isset($_POST["Submit"])) {
  ...
  $DateTime=strftime("%B-%d-%Y %H:%M:%S",$CurrentTime);
    global $ConnectingDB;
    $sql ="UPDATE branch SET name='$Name', number='$Number', post='$Post'WHERE id='$SearchQueryParameter'";
...
<section class="container py-2 mb-4">
  <div class="row">
    <div class="offset-lg-1 col-lg-10" style="min-height:400px;">
      <form class="" action="Editbra.php?id=<?php echo $SearchQueryParameter;  ?>" method="post">
        <div class="card bg text-light mb-3" style="background-color:#4dc47d;">
           ...
           <div class="card-body bg" style="background-color:#133922;">
             <div class="form-group">
               ...
               <input class="form-control" type="text" name="Name" id="title" placeholder="الرجاء شرح المشكلة" value="<?php echo $Name;  ?>"></input>
             </div>
             <div class="form-group">
               <label for="title"><span class="FieldInfo">رقم الطلب: </span></label>
               <input class="form-control" type="text" name="Number" id="title" placeholder="رقم طلب إصلاح المشكلة " value="<?php echo $Number;  ?>"></input>
             </div>
             <div class="form-group">
               <label for="title"><span class="FieldInfo">حالة الطلب: </span></label>
               <input class="form-control" type="text" name="Post" id="title" placeholder="هل تم حل المشكلة ؟" value="<?php echo $Post;  ?>"></input>
             </div>
