...
if (isset($_POST["Submit"])) {
  ...
  $DateTime=strftime("%B-%d-%Y %H:%M:%S",$CurrentTime);
    global $ConnectingDB;
    $sql ="DELETE FROM branch WHERE id='$SearchQueryParameter'";
...
<section class="container py-2 mb-4">
  <div class="row">
    <div class="offset-lg-1 col-lg-10" style="min-height:400px;">
      <form class="" action="Deletebra.php?id=<?php echo $SearchQueryParameter;  ?>" method="post">
