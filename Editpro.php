...
if (isset($_POST["Submit"])) {
  ...
  $DateTime=strftime("%B-%d-%Y %H:%M:%S",$CurrentTime);
    global $ConnectingDB;
    $sql ="UPDATE products SET name='$Name', ser='$Ser', note='$Note' WHERE id='$SearchQueryParameter'";
...
<section class="container py-2 mb-4">
  <div class="row">
    <div class="offset-lg-1 col-lg-10" style="min-height:400px;">
      <form class="" action="Editpro.php?id=<?php echo $SearchQueryParameter;  ?>" method="post">
        <div class="card bg text-light mb-3" style="background-color:#4dc47d;">
           ...
           <div class="card-body bg" style="background-color:#133922;">
             <div class="form-group">
               ...
               <input class="form-control" type="text" name="Name" id="title" placeholder="إسم المنتج" value="<?php echo $Name;  ?>"></input>
             </div>
             <div class="form-group">
               <label for="title"><span class="FieldInfo">الرقم التسلسلي: </span></label>
               <input class="form-control" type="text" name="Ser" id="title" placeholder="الرقم التسلسلي للمنتج " value="<?php echo $Ser;  ?>"></input>
             </div>
             <div class="form-group">
               <label for="title"><span class="FieldInfo">ملاحظات: </span></label>
               <input class="form-control" type="text" name="Note" id="title" placeholder="ملاحظات خاصة بالمنتج" value="<?php echo $Note;  ?>"></input>
             </div>
